    ...
    return (
      <div className="flex items-center justify-center min-h-[400px]">
        <div className="flex items-center gap-2">
          <svg className="animate-spin h-5 w-5 text-cream-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
          ...
          <div className="grid grid-cols-1 gap-6 xl:grid-cols-2">
            ...
            <div className="xl:col-span-2">
              <button
                disabled={loading}
                type="submit"
                className="px-4 py-2  text-black dark:text-white bg-cream-500 dark:bg-cream-800 rounded-md hover:bg-cream-700 focus:outline-none focus:ring-2 focus:ring-cream-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {loading ? (
